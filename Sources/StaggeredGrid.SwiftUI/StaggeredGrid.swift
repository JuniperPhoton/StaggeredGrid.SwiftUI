...
///  [View3] [View4]
///
/// When the width changes, it would invalidate the layout automatically.
///
/// > Note: Currently not support spacing feature, and you would like to apply padding to your views.
...
public struct StaggeredGrid<Content: View>: View {
    ...
    /// Creates a new StaggeredGrid with its content.
    ///
    /// - parameter animated: Whether the width change should be animated.
    /// - parameter content: The content of the StaggeredGrid.
